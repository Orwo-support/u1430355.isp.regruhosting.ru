                                ...
                                <div class="help-modal__content">
                                    ...
                                    <div class="help-modal__section">
                                        <div class="help-modal__picture">
                                            <img class="pic vertical"
                                                 src="/img/typical-solutions-help-vertical.png"
                                                 alt="">
                                        </div>
                                    ...
                                    <div class="help-modal__section">
                                        <div class="help-modal__picture">
                                            <img class="pic horizontal"
                                                 src="/img/typical-solutions-help-horizontal.png"
                                                 alt="">
                                        </div>
                                        <div class="help-modal__caption">
                            ...
                            <div class="help-modal__dialog">
                                <div class="help-modal__content">
                                    ...
                                    <div class="help-modal__text">
                                        ...
                                        adipisicing elit. Ad consequuntur culpa deserunt ducimus eius est facere
                                        illum ipsum minus mollitia officia possimus quam quo quos repellendus,
                                        soluta suscipit, tempora voluptatem?
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="custom-select__list scroller"><?
                                      ...
                                      ?><div class="custom-select__item filter-controller"
                                        ...
                                        <?foreach ($arResult["ITEMS"] as $arItem):?>
                                            ...
                                            <div class="custom-select__item filter-controller"
                                                 data-filter-property="pixelStep"
                                                 data-filter-value="<?=$PIXEL_STEP_VAL?>"><?=$PIXEL_STEP_VAL?></div>
                                        <?endforeach;?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="custom-select__container">
                                    <div class="custom-select__list scroller"><?
                                      ...
                                      ?><div class="custom-select__item filter-controller"
                                        ...
                                        <?foreach ($arResult["ITEMS"] as $arItem):?>
                                            <?$WIDTH_VAL = $arItem['PROPERTIES']['WIDTH']['VALUE'];?>
                                            <div class="custom-select__item filter-controller"
                                                 data-filter-property="width"
                                                 data-filter-value="<?=$WIDTH_VAL?>"><?=$WIDTH_VAL?></div>
                                        <?endforeach;?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ready-cabins__slide swiper-slide"
                            ...
                            <div class="ready-cabins__card animation-element">
                                ...
                                <div class="ready-cabins__params">
                                    ...
                                    <span>Цена/кабинет: <?=$arItem['PROPERTIES']['PRICE']['VALUE']?></span>
                                </div>
