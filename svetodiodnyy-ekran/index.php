...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "ready-cabinets", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"IBLOCK_TYPE" => "ready_cabinets",	// Тип информационного блока (используется только для проверки)
