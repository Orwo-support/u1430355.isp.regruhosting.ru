    ...
    <div class="container calc-results-animation-wrap animation-element">
        <div class="calc__specification hidden invisible">
            ...
            <div class="calc__specification-list">
                ...
                <div class="calc__specification-list-sum"><span>Итого:</span><span
                        class="sum-container">1 320 000 ₽</span></div>
            </div>
            <div class="calc__specification-table scroller">
                <table>
                    ...
                    <tr>
                        <td>1</td>
                        <td>Диффавтомат 16A-30mA 2p 6kA</td>
                        <td>шт</td>
                        <td>26</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Автоматический выключатель 125A 3p 25kA</td>
                        <td>шт</td>
                        <td>1</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Шкаф распределительный навесной</td>
                        <td>шт</td>
                        <td>1</td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>Блок питания 300W 5V IP20</td>
                        <td>шт</td>
                        <td>154</td>
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>Светодиодные LED модули</td>
                        <td>шт</td>
                        <td>924</td>
                    </tr>
                    <tr>
                        <td>6</td>
                        <td>Кабель силовой медный 3x2,5</td>
                        <td>м.п.</td>
                        <td>520</td>
                    </tr>
                    <tr>
                        <td>7</td>
                        <td>Труба гофрированная ПВХ</td>
                        <td>м.п.</td>
                        <td>520</td>
                    </tr>
                    <tr>
                        <td>8</td>
                        <td>Кабель силовой медный 5x50</td>
                        <td>м.п.</td>
                        <td>5</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>10</td>
                        <td>Управление контентом во время мероприятия</td>
                        <td>шт</td>
                        <td>1</td>
                    </tr>
                    <tr>
                        <td>11</td>
                        <td>Монтаж, установка, техническая консультация</td>
                        <td>шт</td>
                        <td>1</td>
                    </tr>
                    <tr>
            ...
            <div class="calc__specification-result">
                <div class="calc__specification-result-sum"><span>Итого:</span><span class="sum-container">1 320 000 ₽</span>
                </div>
                <div class="calc__specification-result-comment">
                    <span>В расчете указана приблизительная стоимость.</span><br><span>Для определения более точной стоимости</span><a
                        class="link revers show-order-form">заполните заявку</a></div>
                <div class="calc__specification-result-download">
                    <div class="btn btn_primary not-focused"><span class="icon-prolog"><svg width="14" height="14"
                                                                                            viewBox="0 0 14 14"
                                                                                            fill="none"
                                                                                            xmlns="http://www.w3.org/2000/svg">
<path d="M5 6.8708L6.99256 9M6.99256 9L9 6.88658M6.99256 9L6.99256 1M11 5C11 5 11.3978 5 11.7654 5.15224C12.2554 5.35523 12.6448 5.74458 12.8478 6.23463C13 6.60218 13 7.06812 13 8V9C13 10.8856 13 11.8284 12.4142 12.4142C11.8284 13 10.8856 13 9 13H5C3.11438 13 2.17157 13 1.58579 12.4142C1 11.8284 1 10.8856 1 9V8C1 7.06812 1 6.60218 1.15224 6.23463C1.35523 5.74458 1.74458 5.35523 2.23463 5.15224C2.60218 5 3 5 3 5"
  stroke="#AB78FF" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</span><span class="d-none sm-visible md-visible">Скачать смету</span><span class="d-none lg-visible xl-visible">Скачать спецификацию</span><span
                            class="icon-epilogue"><svg width="10" height="6" viewBox="0 0 10 6" fill="none"
                                                       xmlns="http://www.w3.org/2000/svg">
<path d="M1 1L4.33333 4.5044C4.6476 4.8348 4.80474 5 5 5C5.19526 5 5.3524 4.8348 5.66667 4.5044L9 1" stroke="#5B4589"
  stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</span></div>
                    <div class="dropdown"><a href="" download><span class="icon"><svg width="14" height="14"
                                                                                      viewBox="0 0 14 14"
                                                                                      fill="none"
                                                                                      xmlns="http://www.w3.org/2000/svg">
<path d="M5 6.8708L6.99256 9M6.99256 9L9 6.88658M6.99256 9L6.99256 1M11 5C11 5 11.3978 5 11.7654 5.15224C12.2554 5.35523 12.6448 5.74458 12.8478 6.23463C13 6.60218 13 7.06812 13 8V9C13 10.8856 13 11.8284 12.4142 12.4142C11.8284 13 10.8856 13 9 13H5C3.11438 13 2.17157 13 1.58579 12.4142C1 11.8284 1 10.8856 1 9V8C1 7.06812 1 6.60218 1.15224 6.23463C1.35523 5.74458 1.74458 5.35523 2.23463 5.15224C2.60218 5 3 5 3 5"
        ...
        <div class="calc__order">
            ...
            <div class="calc__order-form">
                <form class="form-order" id="calcForm" action="/" method="POST" data-target="#calcModal">
                    ...
                    <div class="controller-group"><label class="controller-label">Номер телефона</label>
                        <div class="controller controller__input single-valid-warning"><label
                                class="label label__icon"><span class="controller-icon icon-phone"><img
                                        src="/img/icon-phone.svg" alt=""></span><input class="input" type="text"
                                                                                       placeholder="+7 900 000 00 00"
                                                                                       name="phone"
                                                                                       id="calcFormPhone"></label>
                            <div class="validator validator__cross"><img class="valid"
                                                                         src="/img/icon-validator-cross-valid.svg"
                                                                         alt=""><img class="invalid"
                                                                                     src="/img/icon-validator-cross-invalid.svg"
                                                                                     alt=""></div>
                            <div class="validator validator__check"><img class="valid"
                    ...
                    <div class="controller-group"><label class="controller-label">Email</label>
                        <div class="controller controller__input"><label class="label label__icon"><span
                                    class="controller-icon icon-mail"><img src="/img/icon-calc-mail.svg"
                                                                           alt=""></span><input class="input"
                                                                                                type="text"
                                                                                                placeholder="example@email.com"
                                                                                                name="mail"
                                                                                                id="calcFormMail"></label>
                        </div>
                    </div>
                    <div class="controller-group"><label class="controller-label">Комментарий</label>
                        <div class="controller-wrap"><span class="controller-icon icon-msg"><img
                                    src="/img/icon-message.svg" alt=""></span><textarea class="textarea"
            ...
            <div class="calc__order-result">
                <div class="calc__order-result-pic">
                    <!-- В зависимости от того с какого калькулятора пришли данные добавлять соответствующую картинку-->
                    <!-- img.pic(src="/img/calc-location-outside.png" alt="")-->
                    <!-- img.pic(src="/img/quiz-location-inside.png" alt="")-->
                    <!-- img.pic(src="/img/calc-media-facade.png" alt="")-->
                    <!-- img.pic(src="/img/quiz-location-inside.png" alt="")--><img class="pic"
                                                                                    src="/img/calc-location-outside.png"
                                                                                    alt=""></div>
                <div class="calc__order-result-list">
                    ...
                    <div class="calc__order-result-list-sum"><span>Итого:</span><span class="sum-container">1 320 000 ₽</span>
                    </div>
                </div>
