...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "#SITE_DIR#/nashi-raboty/#ELEMENT_CODE#/",
		"DISPLAY_BOTTOM_PAGER" => "N",
		"DISPLAY_DATE" => "N",
		"DISPLAY_NAME" => "N",
		"DISPLAY_PICTURE" => "Y",
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "feedback", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"PREVIEW_TRUNCATE_LEN" => "",	// Максимальная длина анонса для вывода (только для типа текст)
		"PROPERTY_CODE" => array(	// Свойства
			0 => "FEEDBACK_AUTHOR_SURNAME",
			1 => "FEEDBACK_AUTHOR_NAME",
			2 => "FEEDBACK_AUTHOR_PATRONYMIC",
			3 => "FEEDBACK_AUTHOR_POSITION",
			4 => "FEEDBACK_YOUTUBE_LINK",
			5 => "FEEDBACK_AUTHOR_FACEBOOK",
			6 => "FEEDBACK_AUTHOR_INSTAGRAM",
			7 => "FEEDBACK_AUTHOR_VK",
			8 => "FEEDBACK_AUTHOR_YOUTUBE",
			9 => "",
		),
		"SET_BROWSER_TITLE" => "N",	// Устанавливать заголовок окна браузера
		"SET_LAST_MODIFIED" => "N",	// Устанавливать в заголовках ответа время модификации страницы
